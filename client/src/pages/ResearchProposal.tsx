...
// ── component ─────────────────────────────────────────────────────────────────
export default function ResearchProposal({ onMarkComplete, alreadyCompleted }: { onMarkComplete?: () => void; alreadyCompleted?: boolean } = {}) {
  ...
  const copyProposal = () => {
    if (state.finalProposal) {
      ...
      if (!alreadyCompleted) onMarkComplete?.();
    }
  };
