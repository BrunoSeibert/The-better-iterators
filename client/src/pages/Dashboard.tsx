      ...
      {levelUpVisible && (
        <div className="pointer-events-none fixed inset-0 z-[70] flex items-center justify-center"
          ...
          <div className="flex flex-col items-center gap-5 px-14 py-10 text-center"
            style={{ backgroundColor: 'rgba(250,250,250,1)', border: '2px solid rgba(212,212,216,1)', borderRadius: 18, boxShadow: '0 8px 40px rgba(0,0,0,0.12)', animation: levelUpExiting ? 'levelup-card-out 0.4s ease forwards' : 'levelup-card-in 0.45s cubic-bezier(0.34,1.56,0.64,1) forwards' }}>
            ...
            <div>
              ...
              {levelUpNumber && <p className="mt-2 text-sm" style={{ color: 'rgba(113,113,122,1)' }}>{LEVEL_NAMES[levelUpNumber]} is now unlocked</p>}
            </div>
          </div>
        </div>
      )}
